...
racket_a.color("blue")
racket_a.shapesize(stretch_len=0.5, stretch_wid=5)
racket_a.penup()
racket_a.goto(-350, 0)
...
racket_b.shapesize(stretch_len=0.5, stretch_wid=5)
racket_b.penup()
racket_b.goto(350, 0)
...
# Keyboard
win.listen()
win.onkeypress(racket_a_up, "q")

win.listen()
win.onkeypress(racket_a_down, "a")

win.listen()
win.onkeypress(racket_b_up, "o")
